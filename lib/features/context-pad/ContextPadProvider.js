...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
  ...
  if (element.type === "chr:Profile") {
    createLinkProfilesEntry(actions);
    createLinkNewProfileEntry(actions);
  }
  ...
  function createLinkProfilesEntry(actions) {
    assign(actions, {
      connect: {
        group: "connect",
        className: "bpmn-icon-connection",
        title: "Link Profile to other Profile",
        action: {
          click: startConnect,
          dragstart: startConnect,
        },
  ...
  function createLinkNewProfileEntry(actions) {
    assign(actions, {
      "append.append-task": appendAction(
        "chr:Profile",
        "od-icon-object",
